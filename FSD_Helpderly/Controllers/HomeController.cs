...
namespace FSD_Helpderly.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Form(ElderlyPost elderlyPost)
        {
            ...
            {
                fDal.AddForm(elderlyPost.AdditionalInfo, elderlyPost.Description, elderlyPost.Email, elderlyPost.EndTime, elderlyPost.name, elderlyPost.Location, elderlyPost.MobileNumber, elderlyPost.StartTime);
                return View("FormTY");
            }
